...
<div class="fastweb_div_middle" style="width:1500px;text-align:center;">
    <div class="div_main_frame" style="width:80%;float:left;margin:auto;">
        <div class="div_main_frame" style="width:100%;float:left;margin:0px;padding:0px;">
            <ViewOverallData :json_data="json_data" />
        </div>
    </div>
...
import ViewOverallData from '@/components/ViewOverallData.vue'
...
import "@/assets/fastweb.css"
  ...
  export default {
    ...
    mounted() {
      var api_url = this.host.concat("/api/display_overall");
      ...
      var api_continuous_url = this.host.concat("/api/display_continuous_overall");
